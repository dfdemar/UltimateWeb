...
angular.module('newBetaApp')
  .service('api', function Rest($location) {
    ...
    // If you are running locally the rest requests will normally be directred to ultianalytics.com.  However, if you would like the requests directed to 
    // a local instance of GAE (http://local.appspot.com:8888) then use local.appspot.com in your page URL, e.g., http://local.appspot.com:8888
